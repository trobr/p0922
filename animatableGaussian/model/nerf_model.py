...
class NeRFModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # print("data time: ", now - self.step_finish)
        # self.step_start = now
        ...
        # torch.cuda.synchronize()
        # now = time.perf_counter()
        # print("step time: ", now - self.step_start)
